...
1. **Navigate to Hub:** Go to your project in Hub
2. **Access EdSpace:** Select EdSpace from the services menu
3. **Choose Section:** Select the section you need to work with (Products, Orders, Customers, or Access Codes)
